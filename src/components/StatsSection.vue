...
const stats: Stat[] = [
  { value: '50', label: 'VARIETIES OF COFFEE' },
  { value: '30', label: 'VARIETIES OF PASTRY'  },
  { value: '29', label: 'YEAR EXPERIENCE'      }
]
</script>
...
<template>
  <section>
    ...
    <!-- Stats Bar -->
    <div class="py-14 transition-colors duration-300 bg-white dark:bg-gray-900">
